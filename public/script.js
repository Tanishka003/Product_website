  ...
  if (signupForm) {
      signupForm.addEventListener('submit', function(event) {
          ...
          if (isValid) {
              ...
              // Simulate sending form data to the backend (replace with actual fetch request)
              console.log('Form data:', formData);
              alert('Sign Up Successful!');
              signupForm.reset(); // Optionally reset the form after successful submission
          }
      });
  } else {
...
function showError(input, message) {
  let error = input.nextElementSibling; // Check if error message already exists
